...
const ApproveProduct = () => {
    ...
    useEffect(() => {
        fetchProductList(`${BASE_URL}/v1/products/get-products-list/id?filter[review_status][$eq]=reviewed`)
            ...
            <div className='pr-7'>
                <section>
                    <div className='max-w-6xl mx-auto flex justify-between py-5'>
                        <a href='/' className='text-2xl text-gray-900 font-semibold'>Pending Approval List</a>
