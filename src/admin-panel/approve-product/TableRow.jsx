...
const TableRow = ({ data, index, handleRefresh }) => {
    const { product_images, seller, product_description, parent_category, sub_category, child_category, approval_status, _id
    } = data
    ...
    return (
        <tr class="border-b border-solid border-gray-200 bg-white hover:bg-gray-50 text-[#333333]">
            ...
            <td class="px-2 py-2 capitalize">
                ...
                {product_description?.length > limit && (
                    <span
                        ...
                        className="text-sm text-[#0773DF] cursor-pointer px-2 py-2"
            ...
            <td class="px-2 py-2">
                <div class="flex flex-col">
                    <div
                        ...
                        <p className='whitespace-nowrap font-semibold text-gray-900'>Approve</p>
                    </div>
                    <div
            ...
            <td class="px-2 py-2">
                <div className={`px-4 py-1 rounded  text-center capitalize text-white ${approval_status === 'approved' ? 'bg-green-500' : 'bg-gray-500'}`}>
                    {approval_status}
                </div>
            </td>
        </tr>
